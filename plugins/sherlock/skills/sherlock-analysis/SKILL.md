...
description: Manually run a bounded local Sherlock bottleneck analysis, submit an agent-declared-complete candidate batch, and conduct conversational review. Use only when the user explicitly invokes this skill.
---
