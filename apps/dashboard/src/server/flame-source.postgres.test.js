...
describePostgres("Sherlock Flame Postgres activity boundary", () => {
  it("excludes copied pre-start history after canonical selection", async () => {
    ...
    try {
      ...
      expect(person.buckets[bucketIndex(new Date("2026-08-18T10:10:00.000Z"))]).toEqual([1, 0, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T10:20:00.000Z"))]).toEqual([0, 0, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T10:30:00.000Z"))]).toEqual([0, 0, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T10:40:00.000Z"))]).toEqual([0, 1, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T10:50:00.000Z"))]).toEqual([0, 0, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T11:00:00.000Z"))]).toEqual([0, 1, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T11:10:00.000Z"))]).toEqual([0, 1, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T11:20:00.000Z"))]).toEqual([0, 0, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T11:30:00.000Z"))]).toEqual([0, 0, 1, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T11:40:00.000Z"))]).toEqual([0, 0, 0, 0]);
      expect(person.buckets[bucketIndex(new Date("2026-08-18T12:00:00.000Z"))]).toEqual([0, 0, 0, 0]);
    } finally {
